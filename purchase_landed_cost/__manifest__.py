...
{
    "name": "Distribuciones de costes - Opción alternativa",
    "version": "13.0.1.0.0",
    "author": "ITConsulting",
    "license": "AGPL-3",
    "category": "Purchase Management",
    "website": "https://itcni.odoo.com/",
    "summary": "Distribuciones de costes",
    "depends": ['base','web','stock','purchase',"purchase_stock"],
    "data": [
        ...
        'wizard/confirm_msg_wizard_view.xml',
