...
class PurchaseExpenseType(models.Model):
    ...
    grup_type_cost = fields.Selection(
        [('der_gene', "Derechos Generales"),
         ('cuenta_registro', 'Cuenta de Registro y/o Agencia aduanera'),
         ('almacen', 'Cuenta de Registro Almacén'),
         ('impuesto', 'Impuesto_ISC'),
         ('insurance', 'Insurance'),
         ('freigth_flete', 'Freigth/Flete')], string='Grupo tipo de pago'
    )

    cost_active_inactive = fields.Boolean(
        string="Costo Activo/Inactivo",
        help="Permite activar o desactivar el tipo de costo.", default=True
    )
